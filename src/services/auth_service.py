...
class AuthService:
    ...
    def start_server(self, host_password: str, host_ed25519_private_key: ed25519.Ed25519PrivateKey): 
        ...
        self.server_thread = threading.Thread(
            ...
            args=(self.auth_port, self.stop_event, self.host_password, self.dos_detector, host_ed25519_private_key), 
            daemon=True,
